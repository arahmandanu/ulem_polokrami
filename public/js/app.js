...
var startInvitation = document.getElementById('startInvitation');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // 3. LOGIC COUNTDOWN
  var eventDate = new Date("December 20, 2025 08:00:00").getTime();
  function updateCountdown() {
    ...
    if (distance < 0) {
      ...
      var msgElement = document.getElementById("countdownMessage");
  ...
  document.getElementById('commentForm').addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var from, text, csrfToken, baseUrlElement, url, response, newCommentData, div, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            e.preventDefault();
            from = document.getElementById('name').value;
            text = document.getElementById('message').value; // 2. Get the CSRF token from the meta tag
            csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content'); // Simple validation
            if (!(!from || !text)) {
              _context.n = 1;
              break;
            }
          ...
          case 1:
            _context.p = 1;
            baseUrlElement = document.querySelector('meta[name="app-base-url"]').getAttribute('content');
            url = baseUrlElement + '/create_comment';
            _context.n = 2;
          ...
          case 2:
            ...
            newCommentData = response.data.comment; // --- Update the UI (same logic as before, using data from server) ---
            div = document.createElement('div');
            div.classList.add('border', 'rounded', 'p-3', 'mb-3', 'bg-light');
            div.innerHTML = "\n            <strong>".concat(newCommentData.from, "</strong>\n            <p class=\"mb-0 mt-1\">").concat(newCommentData.text, "</p>\n            <small class=\"text-muted d-block text-end\">Just now</small>\n        ");
          ...
          case 3:
            _context.p = 3;
            _t = _context.v;
            console.error("Error submitting comment:", _t.response || _t);
  ...
  startInvitation.addEventListener('click', function () {
    document.body.classList.remove('no-scroll');
    song.play().then(function () {
      isPlaying = true;
      audioControl.style.display = 'flex';
    })["catch"](function (err) {
      return console.log('Autoplay blocked:', err);
    });
  ...
  var defaultRecipient = "Bapak/Ibu/Saudara/i";
  var recipientName = getQueryParam('to');
  if (recipientName) {
    recipientName = recipientName.replace(/\+/g, ' ');
    var fullname = '';
    if (decodeURIComponent(recipientName)) {
      var parts = decodeURIComponent(recipientName).split(' ');
      // Kapitalisasi setiap kata (lebih baik daripada hanya huruf pertama)
      fullname = parts.map(function (word) {
...
if (loadMoreButton) {
  loadMoreButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var button, originalText, url, response, newCommentsHtml, nextPageUrl, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 2:
            ...
            newCommentsHtml = response.data.html; // Append the new comments to the list
          ...
          case 3:
            _context2.p = 3;
            _t2 = _context2.v;
            console.error("Error loading more comments:", _t2);
            button.disabled = false;
            button.textContent = originalText;
